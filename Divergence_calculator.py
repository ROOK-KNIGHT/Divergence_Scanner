...
# Create directory for chart images - get from environment variables
    ...
    def scan_symbol(self, symbol):
        ...
        try:
            ...
            if "trade_signals" in divergence_results and divergence_results["trade_signals"]:
                ...
                # Track new trade signals
                if has_new_signals:
                    self.trade_signals.extend(new_signals)
                    logger.info(f"Added {len(new_signals)} new trade signals to tracking")
                else:
